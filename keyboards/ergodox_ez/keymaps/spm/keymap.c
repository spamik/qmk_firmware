...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, LM(3, MOD_LGUI | MOD_LALT | MOD_LSFT), KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_F17, LT(3,KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, LSFT_T(KC_CAPS), KC_Z, KC_X, KC_C, KC_V, KC_B, LALT_T(KC_F14), SGUI(KC_SPC), KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_LCTL, KC_LALT, KC_DEL, KC_BSPC, KC_ENT, MO(1), KC_F18, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSLS, KC_F15, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_F16, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RBRC, KC_EQL, KC_MINS, LSFT(KC_DOT), KC_INS, TG(2), KC_RALT, KC_LGUI, LM(1, MOD_LALT), MO(1), KC_LSFT, KC_SPC),
	[1] = LAYOUT_ergodox(RESET, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LSFT, KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LSFT, KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_NO),
